...
var lyrTSABoundaries = new L.Shapefile("data/TSABoundaries2.zip", {onEachFeature: function (feature, layer) {
 ...
 var arrDistCoordinates =[]
  var lyrDistSubDist = new L.Shapefile("data/DISTRICTS_AND_SUBDISTRICTS2.zip", {onEachFeature: function (feature, layer) {
    /* Add some colors based on shapefile features */
    layer.setStyle({
      color: 'orange',
      fillOpacity: 0,
...
var arrZoningCaseCoordinates =[]
    var lyrzoningcasesall = new L.Shapefile("data/ZONING_CASES2.zip", {onEachFeature: function (feature, layer) {
      /* Add some colors based on shapefile features */
...
var lyrZoningApprovedCases = new L.Shapefile("data/ZONING_CASES2.zip", {onEachFeature: function (feature, layer) {
      /* Add some colors based on shapefile features */
...
var lyrZoningUnderReviewCases = new L.Shapefile("data/ZONING_CASES2.zip", {onEachFeature: function (feature, layer) {
        /* Add some colors based on shapefile features */
...
var lyrPreZoningCases = new L.Shapefile("data/ZONING_CASES2.zip", {onEachFeature: function (feature, layer) {
          /* Add some colors based on shapefile features */
          layer.setStyle({
            fillOpacity: 0,
            weight:0,
...
var lyrApprovedResidentialBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
        /* Add some colors based on shapefile features */
...
var lyrApprovedOfficeBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
            /* Add some colors based on shapefile features */
...
var lyrApprovedRetailBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
                /* Add some colors based on shapefile features */
...
var lyrApprovedHotelBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
                    /* Add some colors based on shapefile features */
...
var lyrApprovedInstitutionalBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
                        /* Add some colors based on shapefile features */
...
var lyrApprovedIndustrialBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
                            /* Add some colors based on shapefile features */
...
var lyrInprocessResidentialBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
    /* Add some colors based on shapefile features */
...
var lyrInprocessOfficeBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
        /* Add some colors based on shapefile features */
...
var lyrInprocessRetailBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
            /* Add some colors based on shapefile features */
...
var lyrInprocessHotelBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
                /* Add some colors based on shapefile features */
...
var lyrInprocessInstitutionalBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
                    /* Add some colors based on shapefile features */
...
var lyrInprocessIndustrialBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
                        /* Add some colors based on shapefile features */
 ...
 var lyrInprocessMixedBuildings = new L.Shapefile("data/ZONING_CASES_BLDG2.zip", {onEachFeature: function (feature, layer) {
                            /* Add some colors based on shapefile features */
