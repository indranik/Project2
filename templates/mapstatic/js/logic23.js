...
var lyrTSABoundaries = new L.Shapefile("data/TSABoundaries1.zip", {onEachFeature: function (feature, layer) {
...
var arrZoningCaseCoordinates =[]
    var lyrzoningcasesall = new L.Shapefile("data/ZONING_CASES.zip", {onEachFeature: function (feature, layer) {
      /* Add some colors based on shapefile features */
...
var lyrApprovedResidentialBuildings = new L.Shapefile("data/ZONING_CASES_BLDG.zip", {onEachFeature: function (feature, layer) {
        /* Add some colors based on shapefile features */
